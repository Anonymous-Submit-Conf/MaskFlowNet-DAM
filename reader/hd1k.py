...
# ======== PLEASE MODIFY ========
hd1k_root = '/PATH/TO/flow_dataset/hd1k'

hd1k_image = os.path.join(hd1k_root, 'hd1k_input/image_2')
hd1k_flow_occ = os.path.join(hd1k_root, 'hd1k_flow_gt/flow_occ')
hd1k_path = dict()
...
def read_dataset(path = None, parts = 'mixed', resize = None, samples = -1, normalize = True, crop = (50, 100)):
	...
	print('Number of validates: ', num_valids)
